...
struct XelaDatePickerCell_Previews: PreviewProvider {
    static var previews: some View {
        XelaDatePickerCell(xelaDate: XelaDate(theme_mode: .constant(.dark), date: Date(), xelaManager: XelaDateManager(calendar: Calendar.current, minimumDate: Date(), maximumDate: Date().addingTimeInterval(60 * 60 * 24 * 365), mode: 0)), theme_mode: .constant(.dark))
    }
}
